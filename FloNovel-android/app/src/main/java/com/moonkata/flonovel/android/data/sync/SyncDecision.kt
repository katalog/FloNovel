 ...
 *
 * The Desktop app carries its own copy of these rules (the two apps share no code). Both are pinned
 * by the same case table in their tests, so a change here must be made there too.
 */
...
sealed class SyncAction {
    ...
    /** Remote deleted a file this device had not changed. */
...
object SyncDecision {
     ...
     *
     * [date] arrives already formatted as `yyyy-MM-dd`: java.time needs API 26 and minSdk is 24.
     */
